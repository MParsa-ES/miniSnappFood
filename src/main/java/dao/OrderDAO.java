    ...
    public Optional<Order> findOrderById(Long id) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<Order> query = session.createQuery(
                    "SELECT o FROM Order o LEFT JOIN FETCH o.restaurant LEFT JOIN FETCH o.items oi LEFT JOIN FETCH oi.foodItem LEFT JOIN FETCH o.customer WHERE o.id = :orderId", Order.class);
